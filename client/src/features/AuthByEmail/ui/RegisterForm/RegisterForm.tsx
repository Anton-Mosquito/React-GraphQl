...
import { registrationByUserEmail } from '../../model/services/registrationByUserEmail/registrationByUserEmail';
...
const RegisterForm = memo(({ onSuccess: _onSuccess }: RegisterFormProps) => {
  ...
  const onSubmit = async (data: RegisterFormData) => {
    const result = await dispatch(registrationByUserEmail(data));
    if (registrationByUserEmail.fulfilled.match(result)) {
      saveToStorage(LAST_REGISTERED_EMAIL_KEY, data.email);
